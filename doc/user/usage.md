...
**app.startTime**: The initial time of the simulation. The value defaults to 0.0s
...
**app.timingFile**: If the parameter is set, a timing file will be written which may be used to analyze the performance of FMITerminalBlock and introduced latencies.
